export const TRANSLATION_VN = {
    ...
    selected: "Đã chọn!",
    selectToEdit: "Chọn sản phẩm để chỉnh sửa",
    chooseFrom: "Chọn từ",
    ...
    cancel: "Hủy",
    ok: "Đồng ý",
    addCategory: "Vui lòng nhập tên thể loại",
    addSupplier: "Vui lòng nhập tên nhà cung cấp",
    addTag: "Vui lòng nhập tên nhãn",
    addCollection: "Vui lòng nhập tên bộ sưu tập",
    updated: "Đã cập nhật!",
    added: "Đã thêm!",
    result: "Kết quả",
    ...
    failedByEmptyFilters: "Thất bại! Không tìm thấy bộ lọc nào",
    noMatch: "Xin lỗi, không tìm thấy sản phẩm phù hợp",
    toolTip: "Sắp xếp",
    rowsPerPage: "Số dòng trong mỗi trang:",
    displayRows: "trên",
    search: "Tìm kiếm",
    ...
    title: "BỘ LỌC",
    reset: "THIẾT LẬP LẠI",
    titleColumns: "Hiển thị cột",
    titleAria: "Hiển thị/ Ẩn cột",
    text: "cột được chọn",
}